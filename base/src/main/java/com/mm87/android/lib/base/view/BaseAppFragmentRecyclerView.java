...
public abstract class BaseAppFragmentRecyclerView<T, VH extends RecyclerView.ViewHolder> extends BaseFragment
    ...
    @Override
    protected void init(Bundle savedInstanceState, View v) {
        txtNoHayDatos = v.findViewById(R.id.txt_empty_list);
        swipeRefreshLayout = v.findViewById(R.id.swipeRefreshLayout);
        recyclerView = v.findViewById(R.id.recyclerView);

        recyclerAdapter = new RecyclerAdapter(this.lstItems);
//        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(this.layoutManager == null ? new LinearLayoutManager(getContext()) : this.layoutManager);
